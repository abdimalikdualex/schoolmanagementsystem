...
urlpatterns = [
    ...
    path("fees/types/delete/<int:fee_type_id>/", hod_views.delete_fee_type, name='delete_fee_type'),
    ...
    path("fees/groups/delete/<int:group_id>/", hod_views.delete_fee_group, name='delete_fee_group'),
    path("fees/structures/", hod_views.manage_fee_structures, name='manage_fee_structures'),
    path("fees/structures/delete/<int:structure_id>/", hod_views.delete_fee_structure, name='delete_fee_structure'),
    path("fees/expenses/", hod_views.manage_expenses, name='manage_expenses'),
    path("fees/expenses/add/", hod_views.add_expense, name='add_expense'),
    path("fees/expenses/edit/<int:expense_id>/", hod_views.edit_expense, name='edit_expense'),
    path("fees/expenses/delete/<int:expense_id>/", hod_views.delete_expense, name='delete_expense'),
    ...
    path("fees/reports/daily/", hod_views.finance_daily_report, name='finance_daily_report'),
    path("fees/reports/expense/", hod_views.finance_expense_report, name='finance_expense_report'),
    ...
    path("exams/types/edit/<int:exam_type_id>/", hod_views.edit_exam_type, name='edit_exam_type'),
    path("exams/types/delete/<int:exam_type_id>/", hod_views.delete_exam_type, name='delete_exam_type'),
    ...
    path("exams/results/delete/<int:result_id>/", hod_views.delete_knec_result, name='delete_knec_result'),
    ...
    path("attendance/delete/<int:attendance_id>/", hod_views.delete_class_attendance, name='delete_class_attendance'),
